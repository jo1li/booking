// TODO: surely there is a more legible way to do these
...
export const getDefaultThumbnailImageURL = (imageURL) => {
  return imageURL.replace(/upload\/()v1/gi, 'upload/c_thumb/v1');
}
